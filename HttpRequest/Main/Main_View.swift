...
class MainView: UIViewController {
    ...
    lazy var CancelRequestBtn:UIButton = {
        let button = UIButton()
        button.layer.cornerRadius = 12
        button.backgroundColor = #colorLiteral(red: 0.9529411765, green: 0.9568627451, blue: 0.9607843137, alpha: 1)
    ...
    func OptimizeUIlayout(){
        ...
        SendRequestBtn.bottomAnchor.constraint(equalTo: SendRequestBtn.topAnchor, constant: -32).isActive = true
